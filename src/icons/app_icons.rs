...
#[component]
pub fn HamburgerIcon(class: Option<String>) -> Element {
...
#[component]
pub fn FileIcon(class: Option<String>) -> Element {
    let class = class.unwrap_or_else(|| "w-6 h-6".to_string());
...
#[component]
pub fn LoaderIcon(class: Option<String>) -> Element {
    let class = class.unwrap_or_else(|| "w-6 h-6".to_string());
    ...
    rsx! {
        svg {
            ...
            path { d: "M12 3a9 9 0 0 1 9 9", stroke_dasharray: "15 100" }
        }
    }
}
